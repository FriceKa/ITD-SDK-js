...
async function quickStart() {
    ...
    // ============================================
    // ШАГ 2: Авторизация (автоматическая)
    // ============================================
    console.log('🔐 Шаг 2: Авторизация выполняется автоматически при первом запросе\n');
    console.log('   Достаточно один раз добавить .cookies (с refresh_token) или ITD_ACCESS_TOKEN в .env\n');
    ...
    if (myProfile) {
        ...
        console.log('❌ Не удалось получить профиль. Добавьте .cookies (refresh_token) или ITD_ACCESS_TOKEN в .env\n');
